...
1. Follow `skills/agent-reflect-and-learn/SKILL.md` in order: collect evidence with the collector script, reconstruct the day, scan mistakes and friction, apply the rubric, then write the markdown report and improvement-actions JSON using the bundled template.
2. Use `python3 "${CLAUDE_PLUGIN_ROOT}/skills/agent-reflect-and-learn/scripts/..."` for collector and push steps as documented in the skill.
